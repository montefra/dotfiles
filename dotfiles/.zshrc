...
plugins=(aws command-not-found git kubectl helm history-substring-search node npm terraform zsh-autosuggestions)
...
then
    ...
    # Use newer mvn
    if [ -d "$HOME/software/maven/apache-maven-3.8.6/bin" ] ; then
